...
# Command line
1) $ docker build -t youtube-video-app:1.0 -f Dockerfile.app .
2) $ docker login
3) $ docker tag youtube-video-app:1.0 mglue/youtube-video-app:1.0
4) $ docker push mglue/youtube-video-app:1.0
5) 
# Push Code to GitHub
1) git add . 
